...
function Signup(props) {
    ...
    const [submitTpye , setSubmitType] = React.useState({type : false , id : null})
    ...
    const onSubmit = async (values, { setFieldError }) => {
        ...
        //     values.profile_image = await convertToBase64(values.profile_image);
        // }
            ...
            axios.patch(`http://127.0.0.1:8000/profile/${id}`, formData, {
                ...
                .catch(function (error) {
                    ...
                    if (errorData.status == 400) {
                        if (errorData.data.profile_image) {
                            setFieldError('profile_image', errorData.data.profile_image[0]);
                        }
                    }
                    else {
                        setSubmitType({type : false , id : null})
                                                    ...
                                                    return <div className="flex items-center relative"> {/* Container to hold icon and input */}
                                                        ...
                                                        <DateView
                                                            ...
                                                            onChange={(val) => {
                                                                ...
                                                                const age = calculateAge(formattedDate, '2024-07-01');
