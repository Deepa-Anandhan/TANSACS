        ...
        certificate: Yup.mixed().when(['degree', 'company', 'year', 'course'], {
            ...
            otherwise: () => Yup.mixed().test(
                ...
                .test(
                    'fileSize',
                    'File too large, should be less than 100KB',
                    value => value === undefined || (value && value.size <= 100 * 1024) // 50KB in bytes
                ),
        }),
    }, [
        ['degree', 'company'],
            ...
            .when(['year', 'NOC'], {
                ...
                then: () => Yup.mixed()
                    ...
                    .test(
                        ...
                        value => value === undefined || (value && value.size <= 50 * 1024) // 50KB in bytes
                    ),
                otherwise: () => Yup.mixed()
                ...
                {(formik) => (
                    ...
                    >
                        ...
                        <div className="container font-sans">
                            ...
                            <div className='w-full mb-5 '>
                                <p className='text-custom-red mb-2 text-start underline font-bold'>WORK EXPERIENCE ( IN NACO / TANSACS )</p>

                                <p className='text-xs text-start text-black mt-2 font-bold mb-2'><small className='font-bold text-custom-red text-sm'>Note : </small>  Only for the existing employees of NACO/TANSACS</p>


                                <div className='w-full  border-solid border border-gray-400 rounded-md gap-1 grid grid-cols-10 p-4'>
                                    ...
                                    <div className='lg:col-span-5 col-span-12'>
                                        <div className="grid grid-cols-7 gap-1">
                                            ...
                                            <div className="col-span-2">
                                                ...
                                                <p className='text-start text-xs font-bold mb-2'>In Year:</p>
                                                <FormikControl
                                                    control='input'
                                                    type='text'
                                            ...
                                            <div className="col-span-7 mt-3 grid grid-cols-7 justify-center items-center">
                                                ...
                                                <div className="col-span-2 ">
                                                    <p className='text-center text-sm font-bold'>NOC with Declaration</p>
                                                </div>
                                                <div className="col-span-3 ">
                                                    <FormikControl
                                                        control='file'
